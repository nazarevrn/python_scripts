...
USER_CORE = 'nazarev'
print('\n')
IP = raw_input("Введите IP целевого свича: ")
...
time.sleep(0.5)
print('\n')
print ('Получаем таблицу mac-адресов, минутку...')
time.sleep(60)
...
time.sleep(0.5)
print('\n')
print ('Получаем ARP-таблицу, подождите ещё 2 минуты...')
print('\n')
time.sleep(120)
...
with open('/home/roman/python/venv/PyNEng/labs/vendor&ip_by_mac_automatic/description_result_new_view.txt', 'w') as description_config:
